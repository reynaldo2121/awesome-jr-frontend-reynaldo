	...
	<div class="login-box">
		<div class="login-logo">
			...
			<div class="login-box-body">
				...
				<?php echo form_open('home/login_function');?>
				...
				<div class="row">
					...
					<!-- /.col -->
					<div class="col-xs-12">
						<button type="submit" class="btn-sign">MASUK</button>
					</div>
					<!-- /.col -->
				</div>
				<?php echo form_close();?>
				...
				<div class="login-bawah">
					<p style="text-align:right"> <a href="<?php echo base_url('home/lupa_password'); ?>">Lupa Password</a></p>
					<br><br>

					<p>belum punya Akun ? <a href="<?php echo base_url('home/buatAkun'); ?>">Klik Disini</a> </p>
					<p> <a href="<?php echo base_url('home/'); ?>">Kembali Ke HOME</a></p>
				</div>

				<p style="color:red" align="center"> <?php echo $this->session->flashdata('errorglobal'); ?></p> 
			</div>
			<!-- /.login-box-body -->
		</div>
